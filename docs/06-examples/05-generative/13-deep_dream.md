...
**생성일:** 2016/01/13  
**최종편집일:** 2020/05/02  
**설명:** Generating Deep Dreams with Keras.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/generative/ipynb/deep_dream.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/generative/deep_dream.py){: .btn .btn-blue }
