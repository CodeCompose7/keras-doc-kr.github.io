...
[이 예제]({{ site.baseurl }}/guides/customizing_what_happens_in_fit/)에서 가져왔습니다.
...
[WGAN-GP]({{ site.baseurl }}/examples/generative/wgan_gp)와 같은 레시피를 사용하면, 
