...
**생성일:** 2021/07/13  
**최종편집일:** 2024/01/02  
**설명:** Training a GAN conditioned on class labels to generate handwritten digits.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/generative/ipynb/conditional_gan.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/generative/conditional_gan.py){: .btn .btn-blue }
...
The model definitions (`discriminator`, `generator`, and `ConditionalGAN`) have been adapted from [this example](https://keras.io/guides/customizing_what_happens_in_fit/).
