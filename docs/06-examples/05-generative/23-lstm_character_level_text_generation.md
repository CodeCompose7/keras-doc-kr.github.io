...
**생성일:** 2015/06/15  
**최종편집일:** 2020/04/30  
**설명:** Generate text from Nietzsche's writings with a character-level LSTM.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/generative/ipynb/lstm_character_level_text_generation.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/generative/lstm_character_level_text_generation.py){: .btn .btn-blue }
