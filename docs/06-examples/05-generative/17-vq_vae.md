...
**저자:** [Sayak Paul](https://twitter.com/RisingSayak)  
**생성일:** 2021/07/21  
**최종편집일:** 2021/06/27  
**설명:** Training a VQ-VAE for image reconstruction and codebook sampling for generation.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/generative/ipynb/vq_vae.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/generative/vq_vae.py){: .btn .btn-blue }
...
Now for the encoder and the decoder for the VQ-VAE. We will keep them small so that their capacity is a good fit for the MNIST dataset. The implementation of the encoder and decoder come from [this example](https://keras.io/examples/generative/vae).
...
![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_20_0.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_20_1.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_20_2.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_20_3.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_20_4.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_20_5.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_20_6.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_20_7.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_20_8.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_20_9.png)
...
![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_23_0.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_23_1.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_23_2.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_23_3.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_23_4.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_23_5.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_23_6.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_23_7.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_23_8.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_23_9.png)

The figure above shows that the discrete codes have been able to capture some regularities from the dataset. Now, how do we sample from this codebook to create novel images? Since these codes are discrete and we imposed a categorical distribution on them, we cannot use them yet to generate anything meaningful until we can generate likely sequences of codes that we can give to the decoder. The authors use a PixelCNN to train these codes so that they can be used as powerful priors to generate novel examples. PixelCNN was proposed in [Conditional Image Generation with PixelCNN Decoders](https://arxiv.org/abs/1606.05328) by van der Oord et al. We will borrow code from [this example](https://keras.io/examples/generative/pixelcnn/) by van der Oord et al. We borrow the implementation from [this PixelCNN example](https://keras.io/examples/generative/pixelcnn/). It's an autoregressive generative model where the outputs are conditional on the prior ones. In other words, a PixelCNN generates an image on a pixel-by-pixel basis. For the purpose in this example, however, its task is to generate code book indices instead of pixels directly. The trained VQ-VAE decoder is used to map the indices generated by the PixelCNN back into the pixel space.
...
Majority of this comes from [this example](https://keras.io/examples/generative/pixelcnn/).
...
![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_40_0.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_40_1.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_40_2.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_40_3.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_40_4.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_40_5.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_40_6.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_40_7.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_40_8.png)

![png]({{ site.baseurl }}/img/examples/generative/vq_vae/vq_vae_40_9.png)
