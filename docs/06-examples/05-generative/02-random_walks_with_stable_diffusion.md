---
layout: default
title: 안정적인 Diffusion으로 잠재된 공간 걷기
nav_order: 02+00
...
**생성일:** 2022/09/28  
**최종편집일:** 2022/09/28  
**설명:** Explore the latent manifold of Stable Diffusion.
...
This guide assumes the reader has a high-level understanding of Stable Diffusion. If you haven't already, you should start by reading the [Stable Diffusion Tutorial](https://keras.io/guides/keras_cv/generate_images_with_stable_diffusion/).
