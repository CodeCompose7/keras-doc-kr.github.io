...
[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/generative/ipynb/dcgan_overriding_train_step.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/generative/dcgan_overriding_train_step.py){: .btn .btn-blue }
...
![png]({{ site.baseurl }}/img/examples/generative/dcgan_overriding_train_step/h5MtQZ7l.jpeg)
