---
layout: default
title: WGAN-GP 재정의 `Model.train_step`
nav_order: 09+00
...
# WGAN-GP 재정의 `Model.train_step` (WGAN-GP overriding `Model.train_step`)
{: .no_toc }
...
**생성일:** 2020/05/09  
**최종편집일:** 2023/08/03  
**설명:** `fit()`를 사용하여, CelebA 이미지에 대해 `train_step`을 재정의하여 트레이닝한 간단한 DCGAN입니다.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/generative/ipynb/wgan_gp.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/generative/wgan_gp.py){: .btn .btn-blue }
