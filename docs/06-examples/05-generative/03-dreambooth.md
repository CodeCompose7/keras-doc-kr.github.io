...
*   **Instance prompt**: Denotes a prompt that best describes the "instance images". An example prompt could be - "f"a photo of {unique\_id} {unique\_class}". So, for our example, this becomes - "a photo of sks dog".
