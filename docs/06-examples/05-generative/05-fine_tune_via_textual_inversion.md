...
# Textual Inversion을 통해 StableDiffusion의 새로운 개념 가르치기 (Teach StableDiffusion new concepts via Textual Inversion)
{: .no_toc }
...
**저자:** Ian Stenbit, [lukewood](https://lukewood.xyz)  
**생성일:** 2022/12/09  
**최종편집일:** 2022/12/09  
**설명:** KerasCV의 StableDiffusion 구현을 통해 새로운 시각적 개념을 알아봅니다.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/generative/ipynb/fine_tune_via_textual_inversion.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/generative/fine_tune_via_textual_inversion.py){: .btn .btn-blue }
...
아마도 가장 인상적인 새로운 알고리즘은 [Textual Inversion](https://github.com/rinongal/textual_inversion)으로, [_이미지는 한 단어의 가치가 있다: Textual Inversion을 사용하여 텍스트-이미지 생성 개인화_](https://textual-inversion.github.io/)에 제시되어 있습니다.
...
![https://i.imgur.com/KqEeBsM.jpeg]({{ site.baseurl }}/img/examples/generative/fine_tune_via_textual_inversion/KqEeBsM.jpeg)
...
![https://i.imgur.com/rcb1Yfx.png]({{ site.baseurl }}/img/examples/generative/fine_tune_via_textual_inversion/rcb1Yfx.png)
...
![gh-avatars]({{ site.baseurl }}/img/examples/generative/fine_tune_via_textual_inversion/WyEHDIR.jpeg)
...
![mediocre-wizard]({{ site.baseurl }}/img/examples/generative/fine_tune_via_textual_inversion/Thq7XOu.jpeg)
...
![https://i.imgur.com/gQCRjK6.png]({{ site.baseurl }}/img/examples/generative/fine_tune_via_textual_inversion/gQCRjK6.png)
...
![https://i.imgur.com/GY9Pf3D.png]({{ site.baseurl }}/img/examples/generative/fine_tune_via_textual_inversion/GY9Pf3D.png)
...
[`keras.Model`]({{ site.baseurl }}/api/models/model#model-class)의 하위 클래스입니다. 
이는 Textual Inversion 알고리즘의 핵심입니다.

추상적으로 말해서, 트레이닝 단계는 트레이닝 이미지에 대한 동결된 SD 이미지 인코더의 잠재 분포 출력에서 ​​샘플을 가져오고, 해당 샘플에 노이즈를 추가한 다음, 해당 노이즈 샘플을 동결된 확산 모델에 전달합니다. 
...
트레이닝을 모니터링하기 위해, 
우리는 커스텀 토큰을 사용하여 매 에포크마다 몇 개의 이미지를 생성하는 [`keras.callbacks.Callback`]({{ site.baseurl }}/api/callbacks/base_callback#callback-class)를 생성할 수 있습니다.
