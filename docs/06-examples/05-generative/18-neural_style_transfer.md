...
**생성일:** 2016/01/11  
**최종편집일:** 2020/05/02  
**설명:** Transferring the style of a reference image to target image using gradient descent.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/generative/ipynb/neural_style_transfer.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/generative/neural_style_transfer.py){: .btn .btn-blue }
