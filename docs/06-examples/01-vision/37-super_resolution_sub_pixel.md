---
layout: default
title: Efficient Sub-Pixel CNN을 사용한 이미지 초해상도
nav_order: 37+00
...
**저자:** [Xingyu Long](https://github.com/xingyu-long)  
**생성일:** 2020/07/28  
**최종편집일:** 2020/08/27  
**설명:** Implementing Super-Resolution using Efficient sub-pixel model on BSDS500.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/super_resolution_sub_pixel.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/super_resolution_sub_pixel.py){: .btn .btn-blue }
...
We use the built-in [`keras.utils.get_file`](/api/utils/python_utils#getfile-function) utility to retrieve the dataset.
