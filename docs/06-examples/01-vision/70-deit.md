...
**생성일:** 2022/04/05  
**최종편집일:** 2022/04/08  
**설명:** Distillation of Vision Transformers through attention.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/deit.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/deit.py){: .btn .btn-blue }
...
$$
\mathcal{L}^\text{hardDistill}_\text{global} = \frac{1}{2}\mathcal{L}_\text{CE}(\psi(Z_s), y) + \frac{1}{2}\mathcal{L}_\text{CE}(\psi(Z_s), y_t)
$$
...
*   Z\_s denotes student predictions
*   y denotes true labels
*   y\_t denotes teacher predictions
