...
**저자:** [Abhiraam Eranti](https://github.com/dewball345)  
**생성일:** 2021/11/04  
**최종편집일:** 2021/12/20  
**설명:** A keras implementation of Barlow Twins (constrastive SSL with redundancy reduction).

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/barlow_twins.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/barlow_twins.py){: .btn .btn-blue }
