...
**저자:** [Srihari Humbarwadi](https://twitter.com/srihari_rh)  
**생성일:** 2020/05/17  
**최종편집일:** 2023/07/10  
**설명:** Implementing RetinaNet: Focal Loss for Dense Object Detection.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/retinanet.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/retinanet.py){: .btn .btn-blue }
