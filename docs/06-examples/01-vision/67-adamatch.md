...
**생성일:** 2021/06/19  
**최종편집일:** 2021/06/19  
**설명:** Unifying semi-supervised learning and unsupervised domain adaptation with AdaMatch.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/adamatch.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/adamatch.py){: .btn .btn-blue }
