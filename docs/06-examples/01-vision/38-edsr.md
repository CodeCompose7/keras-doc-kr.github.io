---
layout: default
title: 단일 이미지 초해상도를 위한 향상된 깊은 Residual 네트워크
nav_order: 38+00
...
**생성일:** 2022/04/07  
**최종편집일:** 2022/04/07  
**설명:** Training an EDSR model on the DIV2K Dataset.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/edsr.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/edsr.py){: .btn .btn-blue }
...
Comparison Graph: ![](https://dfzljdn9uc3pi.cloudfront.net/2021/cs-621/1/fig-11-2x.jpg)
...
![](https://miro.medium.com/max/1050/1*EPviXGqlGWotVtV2gqVvNg.png)
