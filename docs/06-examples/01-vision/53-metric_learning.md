...
**저자:** [Mat Kelcey](https://twitter.com/mat_kelcey)  
**생성일:** 2020/06/05  
**최종편집일:** 2020/06/09  
**설명:** Example of using similarity metric learning on CIFAR-10 images.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/metric_learning.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/metric_learning.py){: .btn .btn-blue }
