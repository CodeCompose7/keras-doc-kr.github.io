...
**생성일:** 2022/01/22  
**최종편집일:** 2022/01/22  
**설명:** Building a patch-convnet architecture and visualizing its attention maps.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/patch_convnet.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/patch_convnet.py){: .btn .btn-blue }
