...
**저자:** [Aritra Roy Gosthipaty](https://twitter.com/arig23498), [Sayak Paul](https://twitter.com/RisingSayak)  
**생성일:** 2021/12/20  
**최종편집일:** 2021/12/21  
**설명:** Implementing Masked Autoencoders for self-supervised pretraining.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/masked_image_modeling.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/masked_image_modeling.py){: .btn .btn-blue }
...
As a reference, we reuse some of the code presented in [this example](https://keras.io/examples/vision/image_classification_with_vision_transformer/).
...
This is the trainer module. We wrap the encoder and decoder inside of a [`tf.keras.Model`](/api/models/model#model-class) subclass. This allows us to customize what happens in the `model.fit()` loop.
