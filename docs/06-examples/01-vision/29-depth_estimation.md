...
**생성일:** 2021/08/30  
**최종편집일:** 2021/08/30  
**설명:** Implement a depth estimation model with a convnet.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/depth_estimation.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/depth_estimation.py){: .btn .btn-blue }
