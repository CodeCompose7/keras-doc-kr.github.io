...
**저자:** [Soumik Rakshit](http://github.com/soumik12345)  
**생성일:** 2021/08/31  
**최종편집일:** 2024/01/05  
**설명:** Implement DeepLabV3+ architecture for Multi-class Semantic Segmentation.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/deeplabv3_plus.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/deeplabv3_plus.py){: .btn .btn-blue }
