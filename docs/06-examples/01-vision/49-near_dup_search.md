...
**생성일:** 2021/09/10  
**최종편집일:** 2023/08/30  
**설명:** Building a near-duplicate image search utility using deep learning and locality-sensitive hashing.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/near_dup_search.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/near_dup_search.py){: .btn .btn-blue }
...
There are other examples under [keras.io/examples/vision](https://keras.io/examples/vision) that are worth checking out in this regard:
