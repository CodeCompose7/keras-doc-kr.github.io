...
**저자:** [Sayan Nath](https://twitter.com/sayannath2350)  
**생성일:** 2021/06/08  
**최종편집일:** 2023/11/14  
**설명:** Data augmentation with CutMix for image classification on CIFAR-10.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/cutmix.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/cutmix.py){: .btn .btn-blue }
...
$$
\text{B} = (\text{r}_\text{x}, \text{r}_\text{y}, \text{r}_\text{w}, \text{r}_\text{h})
$$
...
$$
r_x \sim U(0, \text{W}), r_w = W \sqrt{1-\lambda} \\
r_y \sim U(0, \text{H}), r_w = H \sqrt{1-\lambda}
$$
