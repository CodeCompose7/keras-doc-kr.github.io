...
**저자:** [Aritra Roy Gosthipaty](https://twitter.com/ariG23498), [Sayak Paul](https://twitter.com/RisingSayak) (equal contribution), converted to Keras 3 by [Muhammad Anas Raza](https://anasrz.com)  
**생성일:** 2021/12/10  
**최종편집일:** 2023/08/14  
**설명:** Adaptively generating a smaller number of tokens for Vision Transformers.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/token_learner.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/token_learner.py){: .btn .btn-blue }
...
Note that image data augmentation layers do not apply data transformations at inference time. This means that when these layers are called with `training=False` they behave differently. Refer [to the documentation](https://keras.io/api/layers/preprocessing_layers/image_augmentation/) for more details.
