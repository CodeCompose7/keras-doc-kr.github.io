...
**생성일:** 2021/02/28  
**최종편집일:** 2021/02/28  
**설명:** Semantic Clustering by Adopting Nearest neighbors (SCAN) algorithm.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/semantic_image_clustering.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/semantic_image_clustering.py){: .btn .btn-blue }
...
The data preprocessing step resizes the input images to the desired `target_size` and applies feature-wise normalization. Note that, when using [`keras.applications.ResNet50V2`](/api/applications/resnet#resnet50v2-function) as the visual encoder, resizing the images into 255 x 255 inputs would lead to more accurate results but require a longer time to train.
