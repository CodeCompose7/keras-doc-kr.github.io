...
**저자:** [Hasib Zunair](https://twitter.com/hasibzunair)  
**생성일:** 2020/09/23  
**최종편집일:** 2024/01/11  
**설명:** Train a 3D convolutional neural network to predict presence of pneumonia.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/3D_image_classification.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/3D_image_classification.py){: .btn .btn-blue }
