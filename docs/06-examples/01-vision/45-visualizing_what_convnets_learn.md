...
**생성일:** 2020/05/29  
**최종편집일:** 2020/05/29  
**설명:** Displaying the visual patterns that convnet filters respond to.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/visualizing_what_convnets_learn.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/visualizing_what_convnets_learn.py){: .btn .btn-blue }
