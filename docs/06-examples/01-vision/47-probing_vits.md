...
**저자:** [Aritra Roy Gosthipaty](https://twitter.com/ariG23498), [Sayak Paul](https://twitter.com/RisingSayak) (equal contribution)  
**생성일:** 2022/04/12  
**최종편집일:** 2023/11/20  
**설명:** Looking into the representations learned by different Vision Transformers variants.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/probing_vits.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/probing_vits.py){: .btn .btn-blue }
