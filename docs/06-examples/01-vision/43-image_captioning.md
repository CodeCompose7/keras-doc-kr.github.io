...
**생성일:** 2021/05/29  
**최종편집일:** 2021/10/31  
**설명:** Implement an image captioning model using a CNN and a Transformer.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/image_captioning.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/image_captioning.py){: .btn .btn-blue }
