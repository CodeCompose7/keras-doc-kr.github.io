...
**저자:** [Santiago L. Valdarrama](https://twitter.com/svpino)  
**생성일:** 2021/03/01  
**최종편집일:** 2021/03/01  
**설명:** How to train a deep convolutional autoencoder for image denoising.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/autoencoder.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/autoencoder.py){: .btn .btn-blue }
