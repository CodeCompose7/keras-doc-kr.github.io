...
**생성일:** 2021/04/30  
**최종편집일:** 2023/12/18  
**설명:** How to optimally learn representations of images for a given resolution.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/learnable_resizer.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/learnable_resizer.py){: .btn .btn-blue }
