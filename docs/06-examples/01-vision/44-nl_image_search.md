...
**생성일:** 2021/01/30  
**최종편집일:** 2021/01/30  
**설명:** Implementation of a dual encoder model for retrieving images that match natural language queries.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/nl_image_search.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/nl_image_search.py){: .btn .btn-blue }
...
In this example, we use [Xception](https://keras.io/api/applications/xception/) from [Keras Applications](https://keras.io/api/applications/) as the base for the vision encoder.
