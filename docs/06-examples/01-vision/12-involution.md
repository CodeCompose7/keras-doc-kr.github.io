...
**생성일:** 2021/07/25  
**최종편집일:** 2021/07/25  
**설명:** Deep dive into location-specific and channel-agnostic "involution" kernels.
...
Consider an input tensor **X** with dimensions **H**, **W** and **C\_in**. We take a collection of **C\_out** convolution kernels each of shape **K**, **K**, **C\_in**. With the multiply-add operation between the input tensor and the kernels we obtain an output tensor **Y** with dimensions **H**, **W**, **C\_out**.
