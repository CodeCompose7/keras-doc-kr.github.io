...
**생성일:** 2021/09/11  
**최종편집일:** 2023/07/15  
**설명:** Implementing the MIRNet architecture for low-light image enhancement.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/mirnet.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/mirnet.py){: .btn .btn-blue }
