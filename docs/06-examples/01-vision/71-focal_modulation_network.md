...
# 초점 변조(Focal Modulation): 셀프 어텐션을 대체하는
{: .no_toc }
...
**생성일:** 2023/01/25  
**최종편집일:** 2023/02/15  
**설명:** Image classification with Focal Modulation Networks.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/focal_modulation_network.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/focal_modulation_network.py){: .btn .btn-blue }
...
We use the [`keras.Sequential`](/api/models/sequential#sequential-class) API to compose all the individual augmentation steps into one API.
