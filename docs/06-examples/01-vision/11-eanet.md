...
**저자:** [ZhiYong Chang](https://github.com/czy00000)  
**생성일:** 2021/10/19  
**최종편집일:** 2023/07/18  
**설명:** 외부 어텐션을 활용하는 트랜스포머로 이미지를 분류합니다.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/eanet.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/eanet.py){: .btn .btn-blue }
...
EANet은 Vit의 셀프 어텐션을 외부 어텐션으로 대체합니다. 기존 Vit는 50회 트레이닝 후 ~73%의 테스트 top-5위 정확도와 ~41%의 top-1 정확도를 달성했지만, 0.6M 파라미터를 사용했습니다. 동일한 실험 환경과 동일한 하이퍼파라미터에서, 방금 트레이닝한 EANet 모델은 파라미터가 0.3M에 불과하지만, 테스트 top-5 정확도 ~73%, top-1 정확도 ~43%에 도달했습니다. 이는 외부 어텐션의 효과를 충분히 보여줍니다.
