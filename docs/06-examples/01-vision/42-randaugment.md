...
**저자:** [Sayak Paul](https://twitter.com/RisingSayak)[Sachin Prasad](https://github.com/sachinprasadhs)  
**생성일:** 2021/03/13  
**최종편집일:** 2023/12/12  
**설명:** RandAugment for training an image classification model with improved robustness.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/randaugment.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/randaugment.py){: .btn .btn-blue }
