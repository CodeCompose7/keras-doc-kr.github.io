...
**생성일:** 2020/06/02  
**최종편집일:** 2020/06/02  
**설명:** How to obtain integrated gradients for a classification model.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/integrated_gradients.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/integrated_gradients.py){: .btn .btn-blue }
