...
**생성일:** 2021/09/24  
**최종편집일:** 2024/01/03  
**설명:** BigTransfer (BiT) State-of-the-art transfer learning for image classification.
...
![](https://i.imgur.com/XeWVfe7.jpeg) Figure: The x-axis shows the number of images used per class, ranging from 1 to the full dataset. On the plots on the left, the curve in blue above is our BiT-L model, whereas the curve below is a ResNet-50 pre-trained on ImageNet (ILSVRC-2012).
