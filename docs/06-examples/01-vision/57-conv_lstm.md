...
**저자:** [Amogh Joshi](https://github.com/amogh7joshi)  
**생성일:** 2021/06/02  
**최종편집일:** 2023/11/10  
**설명:** How to build and train a convolutional LSTM model for next-frame video prediction.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/conv_lstm.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/conv_lstm.py){: .btn .btn-blue }
