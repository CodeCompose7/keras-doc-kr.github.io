...
**생성일:** 2021/10/08  
**최종편집일:** 2021/10/10  
**설명:** Mitigating resolution discrepancy between training and test sets.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/fixres.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/fixres.py){: .btn .btn-blue }
...
For a comprehensive guide on fine-tuning models in Keras, refer to [this tutorial](https://keras.io/guides/transfer_learning/).
