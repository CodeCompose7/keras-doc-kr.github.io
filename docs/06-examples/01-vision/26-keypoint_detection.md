...
**저자:** [Sayak Paul](https://twitter.com/RisingSayak), converted to Keras 3 by [Muhammad Anas Raza](https://anasrz.com)  
**생성일:** 2021/05/02  
**최종편집일:** 2023/07/19  
**설명:** Training a keypoint detector with data augmentation and transfer learning.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/keypoint_detection.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/vision/keypoint_detection.py){: .btn .btn-blue }
