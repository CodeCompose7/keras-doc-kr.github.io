...
**생성일:** 2021/02/15  
**최종편집일:** 2023/11/15  
**설명:** Using compositional & mixed-dimension embeddings for memory-efficient recommendation models.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/keras_recipes/ipynb/memory_efficient_embeddings.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/keras_recipes/memory_efficient_embeddings.py){: .btn .btn-blue }
