...
**생성일:** 2023/12/13  
**최종편집일:** 2023/12/13  
**설명:** When sharing your deep learning models, package them using the Functional Subclassing pattern.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/keras_recipes/ipynb/packaging_keras_models_for_wide_distribution.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/keras_recipes/packaging_keras_models_for_wide_distribution.py){: .btn .btn-blue }
