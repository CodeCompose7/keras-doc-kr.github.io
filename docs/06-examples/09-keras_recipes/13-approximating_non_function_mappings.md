...
**생성일:** 2023/07/15  
**최종편집일:** 2023/07/15  
**설명:** Approximate non one to one mapping using mixture density networks.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/keras_recipes/ipynb/approximating_non_function_mappings.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/keras_recipes/approximating_non_function_mappings.py){: .btn .btn-blue }
