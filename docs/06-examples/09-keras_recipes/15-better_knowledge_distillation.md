...
**생성일:** 2021/08/01  
**최종편집일:** 2021/08/01  
**설명:** Training better student models via knowledge distillation with function matching.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/keras_recipes/ipynb/better_knowledge_distillation.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/keras_recipes/better_knowledge_distillation.py){: .btn .btn-blue }
...
We will reuse some code from [this example](https://keras.io/examples/vision/knowledge_distillation/) on knowledge distillation.
