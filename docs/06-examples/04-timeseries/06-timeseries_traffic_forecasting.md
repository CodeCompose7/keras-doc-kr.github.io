...
**저자:** [Arash Khodadadi](https://www.linkedin.com/in/arash-khodadadi-08a02490/)  
**생성일:** 2021/12/28  
**최종편집일:** 2023/11/22  
**설명:** This example demonstrates how to do timeseries forecasting over graphs.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/timeseries/ipynb/timeseries_traffic_forecasting.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/timeseries/timeseries_traffic_forecasting.py){: .btn .btn-blue }
...
We use the Keras built-in function [`keras.utils.timeseries_dataset_from_array`](/api/data_loading/timeseries#timeseriesdatasetfromarray-function). The function `create_tf_dataset()` below takes as input a `numpy.ndarray` and returns a [`tf.data.Dataset`](https://www.tensorflow.org/api_docs/python/tf/data/Dataset). In this function `input_sequence_length=T` and `forecast_horizon=h`.
