...
**저자:** [Suvaditya Mukherjee](https://github.com/suvadityamuk)  
**생성일:** 2022/11/03  
**최종편집일:** 2022/11/05  
**설명:** Training a Convolutional model to classify EEG signals produced by exposure to certain stimuli.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/timeseries/ipynb/eeg_signal_classification.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/timeseries/eeg_signal_classification.py){: .btn .btn-blue }
...
|  | id | eeg\_power | raw\_values | signal\_quality | label |
|--|--|--|--|--|--|
