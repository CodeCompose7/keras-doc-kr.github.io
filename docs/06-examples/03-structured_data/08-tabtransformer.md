...
**생성일:** 2022/01/18  
**최종편집일:** 2022/01/18  
**설명:** Using contextual embeddings for structured data classification.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/structured_data/ipynb/tabtransformer.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/structured_data/tabtransformer.py){: .btn .btn-blue }
...
![](https://raw.githubusercontent.com/keras-team/keras-io/master/examples/structured_data/img/tabtransformer/tabtransformer.png)
