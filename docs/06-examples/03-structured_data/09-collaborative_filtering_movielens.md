...
**저자:** [Siddhartha Banerjee](https://twitter.com/sidd2006)  
**생성일:** 2020/05/24  
**최종편집일:** 2020/05/24  
**설명:** Recommending movies using a model trained on Movielens dataset.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/structured_data/ipynb/collaborative_filtering_movielens.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/structured_data/collaborative_filtering_movielens.py){: .btn .btn-blue }
