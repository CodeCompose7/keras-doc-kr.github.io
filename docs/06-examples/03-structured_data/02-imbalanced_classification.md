...
**생성일:** 2019/05/28  
**최종편집일:** 2020/04/17  
**설명:** Demonstration of how to handle highly imbalanced classification problems.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/structured_data/ipynb/imbalanced_classification.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/structured_data/imbalanced_classification.py){: .btn .btn-blue }
