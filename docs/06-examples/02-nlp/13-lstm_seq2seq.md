...
**생성일:** 2017/09/29  
**최종편집일:** 2023/11/22  
**설명:** Character-level recurrent sequence-to-sequence model.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/nlp/ipynb/lstm_seq2seq.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/nlp/lstm_seq2seq.py){: .btn .btn-blue }
