...
**생성일:** 2022/06/01  
**최종편집일:** 2022/12/21  
**설명:** Text Classification on the IMDb Dataset using [`keras_nlp.layers.FNetEncoder`](/api/keras_nlp/modeling_layers/fnet_encoder#fnetencoder-class) layer.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/nlp/ipynb/fnet_classification_with_keras_nlp.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/nlp/fnet_classification_with_keras_nlp.py){: .btn .btn-blue }
...
We'll use the [`keras.utils.text_dataset_from_directory`](/api/data_loading/text#textdatasetfromdirectory-function) utility to generate our labelled [`tf.data.Dataset`](https://www.tensorflow.org/api_docs/python/tf/data/Dataset) dataset from text files.
...
Our FNet classification model consists of three [`keras_nlp.layers.FNetEncoder`](/api/keras_nlp/modeling_layers/fnet_encoder#fnetencoder-class) layers with a [`keras.layers.Dense`](/api/layers/core_layers/dense#dense-class) layer on top.
