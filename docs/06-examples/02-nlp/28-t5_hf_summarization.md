...
nav_order: 28+00
permalink: /examples/nlp/t5_hf_summarization/
parent: 자연어 처리
grand_parent: 코드 예제
---

* 원본 링크 : [https://keras.io/examples/nlp/t5_hf_summarization/](https://keras.io/examples/nlp/t5_hf_summarization/){:target="_blank"}
* 최종 수정일 : 2024-04-13
...
**생성일:** 2022/07/04  
**최종편집일:** 2022/08/28  
**설명:** Training T5 using Hugging Face Transformers for Abstractive Summarization.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/nlp/ipynb/t5_hf_summarization.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/nlp/t5_hf_summarization.py){: .btn .btn-blue }
...
We will use the [Hugging Face Datasets](https://github.com/huggingface/datasets) library to download the data we need to use for training and evaluation. This can be easily done with the `load_dataset` function.
...
The `from_pretrained()` method expects the name of a model from the Hugging Face Model Hub. This is exactly similar to MODEL\_CHECKPOINT declared earlier and we will just pass that.
