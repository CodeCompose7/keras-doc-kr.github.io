...
**저자:** [Varun Singh](https://www.linkedin.com/in/varunsingh2/)  
**생성일:** 2021/06/23  
**최종편집일:** 2024/04/05  
**설명:** NER using the Transformers and data from CoNLL 2003 shared task.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/nlp/ipynb/ner_transformers.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/nlp/ner_transformers.py){: .btn .btn-blue }
...
Build the NER model class as a [`keras.Model`](/api/models/model#model-class) subclass
--------------------------------------------------------------------------------------
