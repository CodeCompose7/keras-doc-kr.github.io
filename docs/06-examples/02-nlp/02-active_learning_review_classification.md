...
**생성일:** 2021/10/29  
**최종편집일:** 2021/10/29  
**설명:** Demonstrating the advantages of active learning through review classification.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/nlp/ipynb/active_learning_review_classification.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/nlp/active_learning_review_classification.py){: .btn .btn-blue }
