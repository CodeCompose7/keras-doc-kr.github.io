...
**저자:** [Smerity](https://twitter.com/Smerity) and others  
**생성일:** 2015/08/17  
**최종편집일:** 2024/02/13  
**설명:** A model that learns to add strings of numbers, e.g. "535+61" -> "596".

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/nlp/ipynb/addition_rnn.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/nlp/addition_rnn.py){: .btn .btn-blue }
