...
**저자:** [Matthew Carrigan](https://twitter.com/carrigmat), [Sayak Paul](https://twitter.com/RisingSayak)  
**생성일:** 2023/05/21  
**최종편집일:** 2023/05/21  
**설명:** Train a masked language model on TPUs using 🤗 Transformers.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/nlp/ipynb/mlm_training_tpus.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/nlp/mlm_training_tpus.py){: .btn .btn-blue }
