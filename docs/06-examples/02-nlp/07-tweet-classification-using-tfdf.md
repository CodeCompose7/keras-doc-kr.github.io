...
**생성일:** 2022/09/05  
**최종편집일:** 2022/09/05  
**설명:** Using Tensorflow Decision Forests for text classification.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/nlp/ipynb/tweet-classification-using-tfdf.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/nlp/tweet-classification-using-tfdf.py){: .btn .btn-blue }
...
We create two models. In the first model (model\_1) raw text will be first encoded via pretrained embeddings and then passed to a Gradient Boosted Tree model for classification. In the second model (model\_2) raw text will be directly passed to the Gradient Boosted Trees model.
...
Prints training logs of model\_1
...
Prints training logs of model\_2
