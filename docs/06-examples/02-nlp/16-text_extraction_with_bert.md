...
**생성일:** 2020/05/23  
**최종편집일:** 2020/05/23  
**설명:** Fine tune pretrained BERT from HuggingFace Transformers on SQuAD.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/nlp/ipynb/text_extraction_with_bert.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/nlp/text_extraction_with_bert.py){: .btn .btn-blue }
