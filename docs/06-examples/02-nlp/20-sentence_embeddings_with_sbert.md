...
**저자:** [Mohammed Abu El-Nasr](https://github.com/abuelnasr0)  
**생성일:** 2023/07/14  
**최종편집일:** 2023/07/14  
**설명:** Fine-tune a RoBERTa model to generate sentence embeddings using KerasNLP.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/nlp/ipynb/sentence_embeddings_with_sbert.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/nlp/sentence_embeddings_with_sbert.py){: .btn .btn-blue }
