...
**생성일:** 2020/05/13  
**최종편집일:** 2024/02/22  
**설명:** Implement Actor Critic Method in CartPole environment.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/rl/ipynb/actor_critic_cartpole.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/rl/actor_critic_cartpole.py){: .btn .btn-blue }
...
In early stages of training: ![Imgur](https://i.imgur.com/5gCs5kH.gif)

In later stages of training: ![Imgur](https://i.imgur.com/5ziiZUD.gif)
