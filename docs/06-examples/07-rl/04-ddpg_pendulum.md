...
**저자:** [amifunny](https://github.com/amifunny)  
**생성일:** 2020/06/04  
**최종편집일:** 2024/03/23  
**설명:** Implementing DDPG algorithm on the Inverted Pendulum Problem.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/rl/ipynb/ddpg_pendulum.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/rl/ddpg_pendulum.py){: .btn .btn-blue }
