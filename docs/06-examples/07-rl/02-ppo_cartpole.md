...
**저자:** [Ilias Chrysovergis](https://twitter.com/iliachry)  
**생성일:** 2021/06/24  
**최종편집일:** 2024/03/12  
**설명:** Implementation of a Proximal Policy Optimization agent for the CartPole-v1 environment.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/rl/ipynb/ppo_cartpole.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/rl/ppo_cartpole.py){: .btn .btn-blue }
