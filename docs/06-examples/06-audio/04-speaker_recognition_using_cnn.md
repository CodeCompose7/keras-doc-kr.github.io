...
**저자:** [Fadi Badine](https://twitter.com/fadibadine)  
**생성일:** 2020/06/14  
**최종편집일:** 2023/07/19  
**설명:** Classify speakers using Fast Fourier Transform (FFT) and a 1D Convnet.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/audio/ipynb/speaker_recognition_using_cnn.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/audio/speaker_recognition_using_cnn.py){: .btn .btn-blue }
...
{{ site.baseurl }}/img/examples/audio/speaker_recognition_using_cnn/speaker_recognition_using_cnn_audio_1.wav

```
Speaker:[92m Julia_Gillard Predicted:[92m Julia_Gillard
```

{{ site.baseurl }}/img/examples/audio/speaker_recognition_using_cnn/speaker_recognition_using_cnn_audio_2.wav

```
Speaker:[92m Nelson_Mandela    Predicted:[92m Nelson_Mandela
```

{{ site.baseurl }}/img/examples/audio/speaker_recognition_using_cnn/speaker_recognition_using_cnn_audio_3.wav

```
Speaker:[92m Magaret_Tarcher   Predicted:[92m Magaret_Tarcher
```

{{ site.baseurl }}/img/examples/audio/speaker_recognition_using_cnn/speaker_recognition_using_cnn_audio_4.wav

```python
Speaker:[92m Julia_Gillard Predicted:[92m Julia_Gillard
```

{{ site.baseurl }}/img/examples/audio/speaker_recognition_using_cnn/speaker_recognition_using_cnn_audio_5.wav

```
Speaker:[92m Julia_Gillard Predicted:[92m Julia_Gillard
```

{{ site.baseurl }}/img/examples/audio/speaker_recognition_using_cnn/speaker_recognition_using_cnn_audio_6.wav

```
Speaker:[92m Jens_Stoltenberg  Predicted:[92m Jens_Stoltenberg
```

{{ site.baseurl }}/img/examples/audio/speaker_recognition_using_cnn/speaker_recognition_using_cnn_audio_7.wav

```
Speaker:[92m Benjamin_Netanyau Predicted:[92m Benjamin_Netanyau
```

{{ site.baseurl }}/img/examples/audio/speaker_recognition_using_cnn/speaker_recognition_using_cnn_audio_8.wav

```
Speaker:[92m Nelson_Mandela    Predicted:[92m Nelson_Mandela
```

{{ site.baseurl }}/img/examples/audio/speaker_recognition_using_cnn/speaker_recognition_using_cnn_audio_9.wav

```
Speaker:[92m Nelson_Mandela    Predicted:[92m Nelson_Mandela
```

{{ site.baseurl }}/img/examples/audio/speaker_recognition_using_cnn/speaker_recognition_using_cnn_audio_10.wav
