...
**저자:** [Apoorv Nandan](https://twitter.com/NandanApoorv)  
**생성일:** 2021/01/13  
**최종편집일:** 2021/01/13  
**설명:** Training a sequence-to-sequence Transformer for automatic speech recognition.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/audio/ipynb/transformer_asr.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/audio/transformer_asr.py){: .btn .btn-blue }
...
For this demonstration, we will use the LJSpeech dataset from the [LibriVox](https://librivox.org/) project. It consists of short audio clips of a single speaker reading passages from 7 non-fiction books. Our model will be similar to the original Transformer (both encoder and decoder) as proposed in the paper, "Attention is All You Need".
