...
**생성일:** 2022/07/01  
**최종편집일:** 2022/08/27  
**설명:** Training Wav2Vec 2.0 using Hugging Face Transformers for Audio Classification.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/audio/ipynb/wav2vec2_audiocls.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/audio/wav2vec2_audiocls.py){: .btn .btn-blue }
...
We write a simple function that helps us in the pre-processing that is compatible with Hugging Face Datasets. To summarize, our pre-processing function should:
