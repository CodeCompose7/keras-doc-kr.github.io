...
**저자:** [Mohamed Reda Bouadjenek](https://rbouadjenek.github.io/) and [Ngoc Dung Huynh](https://www.linkedin.com/in/parkerhuynh/)  
**생성일:** 2021/09/26  
**최종편집일:** 2021/09/26  
**설명:** Training a CTC-based model for automatic speech recognition.

[Colab에서 보기](https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/audio/ipynb/ctc_asr.ipynb){: .btn .btn-blue }
[GitHub 소스](https://github.com/keras-team/keras-io/blob/master/examples/audio/ctc_asr.py){: .btn .btn-blue }
...
|  | file\_name | normalized\_transcription |
|--|--|--|
