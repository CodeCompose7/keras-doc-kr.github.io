...
-   A dataset. You could use any format: a [`tf.data.Dataset`](https://www.tensorflow.org/api_docs/python/tf/data/Dataset), a PyTorch `DataLoader`, a Python generator, etc.
