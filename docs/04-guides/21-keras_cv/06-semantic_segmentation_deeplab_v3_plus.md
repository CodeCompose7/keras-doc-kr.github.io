...
# KerasCV로 시맨틱 세그멘테이션 (Semantic Segmentation with KerasCV)
{: .no_toc }
...
![png]({{ site.baseurl }}/img/guides/semantic_segmentation_deeplab_v3_plus/1_z6ch-2BliDGLIHpOPFY_Sw.webp)
...
이 API에는, 
[`keras_cv.models.DeepLabV3Plus`]({{ site.baseurl }}/api/keras_cv/models/tasks/deeplab_v3_segmentation#deeplabv3plus-class)와 같은, 
...
![png]({{ site.baseurl }}/img/guides/semantic_segmentation_deeplab_v3_plus/semantic_segmentation_deeplab_v3_plus_9_0.png)
...
![png]({{ site.baseurl }}/img/guides/semantic_segmentation_deeplab_v3_plus/semantic_segmentation_deeplab_v3_plus_14_0.png)
...
![png]({{ site.baseurl }}/img/guides/semantic_segmentation_deeplab_v3_plus/semantic_segmentation_deeplab_v3_plus_18_0.png)
...
![png]({{ site.baseurl }}/img/guides/semantic_segmentation_deeplab_v3_plus/learning_rate_schedule.png)
...
![png]({{ site.baseurl }}/img/guides/semantic_segmentation_deeplab_v3_plus/semantic_segmentation_deeplab_v3_plus_28_0.png)
