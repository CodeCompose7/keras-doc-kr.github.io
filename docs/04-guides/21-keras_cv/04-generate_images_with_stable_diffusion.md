...
- [Image Super-Resolution using an Efficient Sub-Pixel CNN]({{ site.baseurl }}/examples/vision/super_resolution_sub_pixel/)
- [Enhanced Deep Residual Networks for single-image super-resolution]({{ site.baseurl }}/examples/vision/edsr/)
...
[Denoising Diffusion Implicit Models]({{ site.baseurl }}/examples/generative/ddim/).
