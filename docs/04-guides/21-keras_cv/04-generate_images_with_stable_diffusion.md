...
![png]({{ site.baseurl }}/img/guides/generate_images_with_stable_diffusion/generate_images_with_stable_diffusion_7_1.png)
...
![png]({{ site.baseurl }}/img/guides/generate_images_with_stable_diffusion/generate_images_with_stable_diffusion_9_1.png)
...
- [효율적인 서브픽셀 CNN을 사용한 이미지 super-resolution]({{ site.baseurl }}/examples/vision/super_resolution_sub_pixel/)
- [단일 이미지 super-resolution를 위한 향상된 딥 Residual 네트워크]({{ site.baseurl }}/examples/vision/edsr/)

![Super-resolution]({{ site.baseurl }}/img/guides/generate_images_with_stable_diffusion/M0XdqOo.png)
...
확산을 심층적으로 이해하려면, 
Keras.io 튜토리얼 [Diffusion 암묵적 모델 노이즈 제거]({{ site.baseurl }}/examples/generative/ddim/)를 확인할 수 있습니다.

![Denoising diffusion]({{ site.baseurl }}/img/guides/generate_images_with_stable_diffusion/FSCKtZq.gif)
...
![The Stable Diffusion architecture]({{ site.baseurl }}/img/guides/generate_images_with_stable_diffusion/2uC8rYJ.png)
...
Keras에서 혼합 정밀도 계산을 활성화하는 것(따라서 [`keras_cv.models.StableDiffusion`]({{ site.baseurl }}/api/keras_cv/models/tasks/stable_diffusion#stablediffusion-class))은, 
다음을 호출하는 것만큼 간단합니다.
...
[`keras_cv.models.StableDiffusion`]({{ site.baseurl }}/api/keras_cv/models/tasks/stable_diffusion#stablediffusion-class)는 기본적으로 `jit_compile` 인수를 지원합니다. 
...
![png]({{ site.baseurl }}/img/guides/generate_images_with_stable_diffusion/generate_images_with_stable_diffusion_21_1.png)
...
![png]({{ site.baseurl }}/img/guides/generate_images_with_stable_diffusion/generate_images_with_stable_diffusion_23_1.png)
...
![png]({{ site.baseurl }}/img/guides/generate_images_with_stable_diffusion/generate_images_with_stable_diffusion_28_1.png)
...
![png]({{ site.baseurl }}/img/guides/generate_images_with_stable_diffusion/generate_images_with_stable_diffusion_30_1.png)
