...
The highest level module in KerasCV is a _task_. A _task_ is a [`keras.Model`]({{ site.baseurl }}/api/models/model#model-class) consisting of a (generally pretrained) backbone model and task-specific layers. Here's an example using [`keras_cv.models.ImageClassifier`]({{ site.baseurl }}/api/keras_cv/models/tasks/image_classifier#imageclassifier-class) with an EfficientNetV2B0 Backbone.
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_7_0.png)
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_17_0.png)

![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_17_1.png)
...
Here our classifier is just a simple [`keras.Sequential`]({{ site.baseurl }}/api/models/sequential#sequential-class). All that is left to do is call `model.fit()`:
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_28_0.png)
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_30_0.png)
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_32_0.png)
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_34_0.png)
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_36_16.png)
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_38_0.png)
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_40_0.png)
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_44_0.png)

We also need to resize our evaluation set to get dense batches of the image size expected by our model. We use the deterministic [`keras_cv.layers.Resizing`]({{ site.baseurl }}/api/keras_cv/layers/preprocessing/resizing#resizing-class) in this case to avoid adding noise to our evaluation metric.
...
![png]({{ site.baseurl }}/img/guides/classification_with_keras_cv/classification_with_keras_cv_46_0.png)
...
![WarmUpCosineDecay schedule]({{ site.baseurl }}/img/guides/classification_with_keras_cv/YCr5pII.png)
...
*   Learn more about [KerasCV's data augmentations]({{ site.baseurl }}/guides/keras_cv/cut_mix_mix_up_and_rand_augment/)
