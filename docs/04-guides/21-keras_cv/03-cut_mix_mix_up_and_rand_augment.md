...
Perhaps three of the most useful layers are [`keras_cv.layers.CutMix`]({{ site.baseurl }}/api/keras_cv/layers/augmentation/cut_mix#cutmix-class), [`keras_cv.layers.MixUp`]({{ site.baseurl }}/api/keras_cv/layers/augmentation/mix_up#mixup-class), and [`keras_cv.layers.RandAugment`]({{ site.baseurl }}/api/keras_cv/layers/augmentation/rand_augment#randaugment-class). These layers are used in nearly all state-of-the-art image classification pipelines.
...
![png]({{ site.baseurl }}/img/guides/cut_mix_mix_up_and_rand_augment/cut_mix_mix_up_and_rand_augment_11_0.png)
...
You can read more about these parameters in the [`RandAugment` API documentation]({{ site.baseurl }}/api/keras_cv/layers/preprocessing/rand_augment/).
...
![png]({{ site.baseurl }}/img/guides/cut_mix_mix_up_and_rand_augment/cut_mix_mix_up_and_rand_augment_17_0.png)
...
![png]({{ site.baseurl }}/img/guides/cut_mix_mix_up_and_rand_augment/cut_mix_mix_up_and_rand_augment_20_0.png)
...
Next, let's add [`keras_cv.layers.GridMask`]({{ site.baseurl }}/api/keras_cv/layers/augmentation/grid_mask#gridmask-class) to our layers:
...
![png]({{ site.baseurl }}/img/guides/cut_mix_mix_up_and_rand_augment/cut_mix_mix_up_and_rand_augment_32_0.png)
...
![png]({{ site.baseurl }}/img/guides/cut_mix_mix_up_and_rand_augment/cut_mix_mix_up_and_rand_augment_36_0.png)
...
![png]({{ site.baseurl }}/img/guides/cut_mix_mix_up_and_rand_augment/cut_mix_mix_up_and_rand_augment_39_0.png)
...
Currently, between Keras core and KerasCV there are [_28 image augmentation layers_]({{ site.baseurl }}/api/keras_cv/layers/preprocessing)! Each of these can be used independently, or in a pipeline. Check them out, and if you find an augmentation techniques you need is missing please file a [GitHub issue on KerasCV](https://github.com/keras-team/keras-cv/issues).
