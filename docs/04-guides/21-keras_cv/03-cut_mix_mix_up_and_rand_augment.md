...
[`keras_cv.layers.CutMix`]({{ site.baseurl }}/api/keras_cv/layers/augmentation/cut_mix#cutmix-class), 
[`keras_cv.layers.MixUp`]({{ site.baseurl }}/api/keras_cv/layers/augmentation/mix_up#mixup-class), 
[`keras_cv.layers.RandAugment`]({{ site.baseurl }}/api/keras_cv/layers/augmentation/rand_augment#randaugment-class)일 것입니다. 
...
[`RandAugment` API 문서]({{ site.baseurl }}/api/keras_cv/layers/preprocessing/rand_augment/)에서 확인할 수 있습니다.
...
[`keras_cv.layers.GridMask`]({{ site.baseurl }}/api/keras_cv/layers/augmentation/grid_mask#gridmask-class)를 포함하고 싶을 것입니다.

KerasCV를 사용하면, [`keras_cv.layers.RandomAugmentationPipeline`]({{ site.baseurl }}/api/keras_cv/layers/augmentation/random_augmentation_pipeline#randomaugmentationpipeline-class) 레이어를 사용하여, 프로덕션 등급의 커스텀 데이터 보강 파이프라인을 구성할 수 있습니다. 
...
다음으로, 레이어에 [`keras_cv.layers.GridMask`]({{ site.baseurl }}/api/keras_cv/layers/augmentation/grid_mask#gridmask-class)를 추가해 보겠습니다.
...
현재, Keras 코어와 KerasCV 사이에는 [_28개의 이미지 보강 레이어_]({{ site.baseurl }}/api/keras_cv/layers/preprocessing)가 있습니다! 
