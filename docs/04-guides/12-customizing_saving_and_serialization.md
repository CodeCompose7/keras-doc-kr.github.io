...
This guide covers advanced methods that can be customized in Keras saving. For most users, the methods outlined in the primary [Serialize, save, and export guide]({{ site.baseurl }}/guides/serialization_and_saving) are sufficient.
