...
# 빌트인 메서드를 사용한 트레이닝 및 평가 (Training & evaluation with the built-in methods)
{: .no_toc }
...
* [TensorFlow로 커스텀 트레이닝 스텝 작성]({{ site.baseurl }}/guides/custom_train_step_in_tensorflow/)
* [JAX로 커스텀 트레이닝 스텝 작성]({{ site.baseurl }}/guides/custom_train_step_in_jax/)
* [PyTorch로 커스텀 트레이닝 스텝 작성]({{ site.baseurl }}/guides/custom_train_step_in_torch/)

자체 트레이닝 및 평가 루프를 처음부터 작성하는 데 관심이 있다면, 트레이닝 루프 작성에 대한 가이드를 참조하세요.

* [TensorFlow로 트레이닝 루프 작성]({{ site.baseurl }}/guides/writing_a_custom_training_loop_in_tensorflow/)
* [JAX로 트레이닝 루프 작성]({{ site.baseurl }}/guides/writing_a_custom_training_loop_in_jax/)
* [PyTorch로 트레이닝 루프 작성]({{ site.baseurl }}/guides/writing_a_custom_training_loop_in_torch/)
...
* [`keras.utils.PyDataset`]({{ site.baseurl }}/api/utils/python_utils#pydataset-class)의 하위 클래스
...
[`keras.metrics.Metric`]({{ site.baseurl }}/api/metrics/base_metric#metric-class) 클래스를 서브클래싱하여, 
...
----------------------------------------------------------------------------------------------------
{: #training--evaluation-using-tfdata-datasets}
...
[`keras.utils.PyDataset`]({{ site.baseurl }}/api/utils/python_utils#pydataset-class)는 두 가지 중요한 속성이 있는 Python generator를 얻기 위해 서브클래싱할 수 있는 유틸리티입니다.
...
![png]({{ site.baseurl }}/img/guides/training_with_built_in_methods/training_with_built_in_methods_73_0.png)
...
전체 목록은 [콜백 문서]({{ site.baseurl }}/api/callbacks/)를 참조하세요.

### 자신만의 콜백 작성하기
{: #writing-your-own-callback}
<!-- ### Writing your own callback -->

베이스 클래스 [`keras.callbacks.Callback`]({{ site.baseurl }}/api/callbacks/base_callback#callback-class)를 확장하여, 커스텀 콜백을 만들 수 있습니다. 
콜백은 클래스 속성 `self.model`을 통해, 연관된 모델에 액세스할 수 있습니다.

[커스텀 콜백 작성에 대한 전체 가이드]({{ site.baseurl }}/guides/writing_your_own_callbacks/)를 읽어보세요.
...
직렬화 및 저장에 대한 전체 가이드는 [모델 저장 및 직렬화 가이드]({{ site.baseurl }}/guides/serialization_and_saving/)를 참조하세요.
