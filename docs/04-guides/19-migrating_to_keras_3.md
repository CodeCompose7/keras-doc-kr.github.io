...
| TensorFlow | Keras 3.0 | 
| --- | --- |
| [`tf.nn.sigmoid_cross_entropy_with_logits`](https://www.tensorflow.org/api_docs/python/tf/nn/sigmoid_cross_entropy_with_logits) | [`keras.ops.binary_crossentropy`]({{ site.baseurl }}/api/ops/nn#binarycrossentropy-function) (mind the `from_logits` argument) |
| [`tf.nn.sparse_softmax_cross_entropy_with_logits`](https://www.tensorflow.org/api_docs/python/tf/nn/sparse_softmax_cross_entropy_with_logits) | [`keras.ops.sparse_categorical_crossentropy`]({{ site.baseurl }}/api/ops/nn#sparsecategoricalcrossentropy-function) (mind the `from_logits` argument) |
...
| [`tf.nn.batch_normalization`](https://www.tensorflow.org/api_docs/python/tf/nn/batch_normalization) | No direct equivalent; use [`keras.layers.BatchNormalization`]({{ site.baseurl }}/api/layers/normalization_layers/batch_normalization#batchnormalization-class) |
| [`tf.nn.dropout`](https://www.tensorflow.org/api_docs/python/tf/nn/dropout) | [`keras.random.dropout`]({{ site.baseurl }}/api/random/random_ops#dropout-function) | [`tf.nn.embedding_lookup`](https://www.tensorflow.org/api_docs/python/tf/nn/embedding_lookup) | [`keras.ops.take`]({{ site.baseurl }}/api/ops/numpy#take-function) |
| [`tf.nn.l2_normalize`](https://www.tensorflow.org/api_docs/python/tf/nn/l2_normalize) | [`keras.utils.normalize`]({{ site.baseurl }}/api/utils/python_utils#normalize-function) (not an op) |
...
-   [Customizing what happens in `fit()` with JAX]({{ site.baseurl }}/guides/custom_train_step_in_jax/)
-   [Customizing what happens in `fit()` with TensorFlow]({{ site.baseurl }}/guides/custom_train_step_in_tensorflow/)
-   [Customizing what happens in `fit()` with PyTorch]({{ site.baseurl }}/guides/custom_train_step_in_torch/)
...
To address this, you should pass as the `seed` argument an instance of a stateful [`keras.random.SeedGenerator`]({{ site.baseurl }}/api/random/seed_generator#seedgenerator-class) object, like this:
