...
[\[source\]](https://github.com/keras-team/keras/tree/v3.3.3//keras/src/applications/resnet.py#L382)
...
*   **classifier\_activation**: A `str` or callable. The activation function to use on the "top" layer. Ignored unless `include_top=True`. Set `classifier_activation=None` to return the logits of the "top" layer. When loading pretrained weights, `classifier_activation` can only be `None` or `"softmax"`.
...
[\[source\]](https://github.com/keras-team/keras/tree/v3.3.3//keras/src/applications/resnet.py#L421)
...
[\[source\]](https://github.com/keras-team/keras/tree/v3.3.3//keras/src/applications/resnet.py#L459)
...
[\[source\]](https://github.com/keras-team/keras/tree/v3.3.3//keras/src/applications/resnet_v2.py#L6)
...
[\[source\]](https://github.com/keras-team/keras/tree/v3.3.3//keras/src/applications/resnet_v2.py#L46)
...
[\[source\]](https://github.com/keras-team/keras/tree/v3.3.3//keras/src/applications/resnet_v2.py#L86)
